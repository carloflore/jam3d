...
# GK approximate
conf['params']['gk']={}
conf['params']['gk']['gk0']  ={'value':   -1.18574e-01,'min': -10,'max':10,'fixed':False}
conf['params']['gk']['Q0']  ={'value':    1.47545e+00,'min':0.8,'max':4,'fixed':False}

# TMD PDF:
conf['params']['pdf']={}
conf['params']['pdf']['widths1_uv']  ={'value':    5.50457e-01,'min': 0,'max':1,'fixed':False}
conf['params']['pdf']['widths2_uv']  ={'value':    0.00000e+00,'min':-1,'max':1,'fixed':True}
conf['params']['pdf']['widths1_dv']  ={'value':    5.50457e-01,'min': 0,'max':1,'fixed':'widths1_uv'}
conf['params']['pdf']['widths2_dv']  ={'value':    0.00000e+00,'min':-1,'max':1,'fixed':'widths2_uv'}
conf['params']['pdf']['widths1_sea'] ={'value':    6.44656e-01,'min': 0,'max':1,'fixed':False}
conf['params']['pdf']['widths2_sea'] ={'value':    0.00000e+00,'min':-1,'max':1,'fixed':True}

# TMD FF:
conf['params']['ffpi']={}
conf['params']['ffpi']['widths1_fav']   ={'value':    1.19014e-01,'min': 0,'max':1,'fixed':False}
conf['params']['ffpi']['widths2_fav']   ={'value':    0.00000e+00,'min':-1,'max':1,'fixed':True}
conf['params']['ffpi']['widths1_ufav'] ={'value':    1.39228e-01,'min': 0,'max':1,'fixed':False}
...
conf['params']['ffk']['widths1_ufav']  ={'value':   -1.83724e-01,'min': 0,'max':1,'fixed':False}
