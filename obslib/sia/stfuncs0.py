...
def get_Wq(z1, z2, k1, k2, Q2, hadron1, hadron2):
    ...
    W1 = z1**2 * get_cc(conf[k1+had2].get_widths(Q2))

    if hadron1.endswith('-'):
        W2 = z2**2 * get_cc(conf[k2+had1].get_widths(Q2))

    if hadron2.endswith('-'):
        W1 = z1**2 * conf[k1+had2].get_widths(Q2)
...
def ZX(i, z1, z2, Q2, pT, hadron1, hadron2):
    ...
    D2 = get_cc(conf[k2+had2].get_C(z2, Q2))
