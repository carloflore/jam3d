...
conf['params']['Htildepi']['u N0 1'] ={'value':    1.04995e-01,'min': -15, 'max': 10, 'fixed':False}
conf['params']['Htildepi']['u N1 1'] ={'value':    0.00000e+00,'min': -10, 'max': 10, 'fixed':True}
conf['params']['Htildepi']['u a0 1'] ={'value':   1.48089e-02,'min':-2, 'max': 5, 'fixed':False}
conf['params']['Htildepi']['u a1 1'] ={'value':    0.00000e+00,'min':-2, 'max': 5, 'fixed':True}
conf['params']['Htildepi']['u b0 1'] ={'value':    0.00000e+00,'min': 0, 'max':10, 'fixed':False}
...
conf['params']['Htildepi']['d N0 1'] ={'value':   -1.09166e-01,'min': -10, 'max': 10, 'fixed':False}
conf['params']['Htildepi']['d N1 1'] ={'value':    0.00000e+00,'min': 0, 'max': 1, 'fixed':True}
conf['params']['Htildepi']['d a0 1'] ={'value':    -6.77752e-03,'min':-2, 'max': 2, 'fixed':False}
conf['params']['Htildepi']['d a1 1'] ={'value':    0.00000e+00,'min':-2, 'max': 2, 'fixed':True}
conf['params']['Htildepi']['d b0 1'] ={'value':    4.06353e-02,'min': 0, 'max':10, 'fixed':False}
