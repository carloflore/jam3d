...
conf['params']['Htildepi']['u N0 1'] ={'value':    1.52948533965102861920e+00,'min': -15, 'max': 2, 'fixed':False}
conf['params']['Htildepi']['u N1 1'] ={'value':    0.00000e+00,'min': -10, 'max': 10, 'fixed':True}
conf['params']['Htildepi']['u a0 1'] ={'value':   -1.26297747035769281077e+00,'min':-2.5, 'max': 5, 'fixed':False}
conf['params']['Htildepi']['u a1 1'] ={'value':    0.00000e+00,'min':-2, 'max': 5, 'fixed':True}
conf['params']['Htildepi']['u b0 1'] ={'value':    3.03348994081082601326e+00,'min': 0, 'max':10, 'fixed':False}
...
conf['params']['Htildepi']['d N0 1'] ={'value':   -6.70019661848445480246e+00,'min': -10, 'max': 10, 'fixed':False}
conf['params']['Htildepi']['d N1 1'] ={'value':    0.00000e+00,'min': 0, 'max': 1, 'fixed':True}
conf['params']['Htildepi']['d a0 1'] ={'value':    7.90788237407234806398e-01,'min':-2, 'max': 2, 'fixed':False}
conf['params']['Htildepi']['d a1 1'] ={'value':    0.00000e+00,'min':-2, 'max': 2, 'fixed':True}
conf['params']['Htildepi']['d b0 1'] ={'value':    3.02696426160740239553e+00,'min': 0, 'max':10, 'fixed':False}
