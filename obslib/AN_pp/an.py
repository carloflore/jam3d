...
conf['params']['collinspi']['u N0 1'] ={'value':    4.57728e+00,'min': -15, 'max': 10, 'fixed':False}
conf['params']['collinspi']['u N1 1'] ={'value':    0.00000e+00,'min': -10, 'max': 10, 'fixed':True}
conf['params']['collinspi']['u a0 1'] ={'value':   -1.69752e+00,'min':-2, 'max': 5, 'fixed':False}
conf['params']['collinspi']['u a1 1'] ={'value':    0.00000e+00,'min':-2, 'max': 5, 'fixed':True}
conf['params']['collinspi']['u b0 1'] ={'value':    3.21116e+00,'min': 0, 'max':10, 'fixed':False}
...
conf['params']['collinspi']['d N0 1'] ={'value':   -7.04399e+00,'min': -10, 'max': 10, 'fixed':False}
conf['params']['collinspi']['d N1 1'] ={'value':    0.00000e+00,'min': 0, 'max': 1, 'fixed':True}
conf['params']['collinspi']['d a0 1'] ={'value':    1.15031e+00,'min':-2, 'max': 2, 'fixed':False}
conf['params']['collinspi']['d a1 1'] ={'value':    0.00000e+00,'min':-2, 'max': 2, 'fixed':True}
conf['params']['collinspi']['d b0 1'] ={'value':    1.82320e+00,'min': 0, 'max':10, 'fixed':False}
...
conf['params']['collinspi']['s N0 1'] ={'value':   -7.04399e+00,'min': 0, 'max': 1, 'fixed':'d N0 1'}
conf['params']['collinspi']['s N1 1'] ={'value':    0.00000e+00,'min': 0, 'max': 1, 'fixed':'d N1 1'}
conf['params']['collinspi']['s a0 1'] ={'value':    1.15031e+00,'min':-2, 'max': 2, 'fixed':'d a0 1'}
conf['params']['collinspi']['s a1 1'] ={'value':    0.00000e+00,'min':-2, 'max': 2, 'fixed':'d a1 1'}
conf['params']['collinspi']['s b0 1'] ={'value':    1.82320e+00,'min': 0, 'max':10, 'fixed':'d b0 1'}
...
conf['params']['collinspi']['ub N0 1'] ={'value':   -7.04399e+00,'min': -15, 'max': 2,  'fixed':'d N0 1'}
conf['params']['collinspi']['ub N1 1'] ={'value':    0.00000e+00,'min': -10, 'max': 10, 'fixed':'d N1 1'}
conf['params']['collinspi']['ub a0 1'] ={'value':    1.15031e+00,'min':-2.5, 'max': 5,  'fixed':'d a0 1'}
conf['params']['collinspi']['ub a1 1'] ={'value':    0.00000e+00,'min':-2, 'max': 5,    'fixed':'d a1 1'}
conf['params']['collinspi']['ub b0 1'] ={'value':    1.82320e+00,'min': 0, 'max':10,    'fixed':'d b0 1'}
...
conf['params']['collinspi']['db N0 1'] ={'value':    4.57728e+00,'min': -15, 'max': 2,  'fixed':'u N0 1'}
conf['params']['collinspi']['db N1 1'] ={'value':    0.00000e+00,'min': -10, 'max': 10, 'fixed':'u N1 1'}
conf['params']['collinspi']['db a0 1'] ={'value':   -1.69752e+00,'min':-2.5, 'max': 5,  'fixed':'u a0 1'}
conf['params']['collinspi']['db a1 1'] ={'value':    0.00000e+00,'min':-2, 'max': 5,    'fixed':'u a1 1'}
conf['params']['collinspi']['db b0 1'] ={'value':    3.21116e+00,'min': 0, 'max':10,    'fixed':'u b0 1'}
...
conf['params']['collinspi']['sb N0 1'] ={'value':   -7.04399e+00,'min': -15, 'max': 2,  'fixed':'d N0 1'}
conf['params']['collinspi']['sb N1 1'] ={'value':    0.00000e+00,'min': -10, 'max': 10, 'fixed':'d N1 1'}
conf['params']['collinspi']['sb a0 1'] ={'value':    1.15031e+00,'min':-2.5, 'max': 5,  'fixed':'d a0 1'}
conf['params']['collinspi']['sb a1 1'] ={'value':    0.00000e+00,'min':-2, 'max': 5,    'fixed':'d a1 1'}
conf['params']['collinspi']['sb b0 1'] ={'value':    1.82320e+00,'min': 0, 'max':10,    'fixed':'d b0 1'}
...
conf['params']['transversity']['widths1_uv']  ={'value':    5.24140e-01, 'min':0, 'max':1, 'fixed': True}
conf['params']['transversity']['widths1_dv']  ={'value':    5.24140e-01, 'min':0, 'max':1, 'fixed': 'widths1_uv'}
conf['params']['transversity']['widths1_sea'] ={'value':    4.04126e-01, 'min':0, 'max':1, 'fixed': True}
...
conf['params']['transversity']['u N0 1'] ={'value':    4.00000e+00, 'min': -10.0, 'max': 10.0, 'fixed': False}
conf['params']['transversity']['u N1 1'] ={'value':    0.00000e+00, 'min': -10.0, 'max': 1.0, 'fixed': True}
conf['params']['transversity']['u a0 1'] ={'value':    1.43340e+00, 'min':-2.0, 'max':10.0, 'fixed': False}
conf['params']['transversity']['u a1 1'] ={'value':    0.00000e+00, 'min':-2.0, 'max':10.0, 'fixed': True}
conf['params']['transversity']['u b0 1'] ={'value':    5.28987e+00, 'min': 0.0, 'max':10.0, 'fixed': False}
...
conf['params']['transversity']['d N0 1'] ={'value':   -9.67335e+00, 'min': -20.0, 'max': 10.0, 'fixed': False}
conf['params']['transversity']['d N1 1'] ={'value':    0.00000e+00, 'min': 0.0, 'max': 1.0, 'fixed': True}
conf['params']['transversity']['d a0 1'] ={'value':    1.97654e+00, 'min':-2.0, 'max':10.0, 'fixed': False}
conf['params']['transversity']['d a1 1'] ={'value':    0.00000e+00, 'min':-2.0, 'max':10.0, 'fixed': True}
conf['params']['transversity']['d b0 1'] ={'value':    4.54321e+00, 'min': 0.0, 'max':10.0, 'fixed': False}
...
conf['params']['Htildepi']['widths1_fav']   ={'value':    1.0,'min':0, 'max':1, 'fixed':True}
conf['params']['Htildepi']['widths1_ufav'] ={'value':    1.0,'min':0, 'max':1, 'fixed':True}
...
conf['params']['Htildepi']['u N0 1'] ={'value':    0.0,'min': -15, 'max': 10, 'fixed':False}
conf['params']['Htildepi']['u N1 1'] ={'value':    0.00000e+00,'min': -10, 'max': 10, 'fixed':True}
conf['params']['Htildepi']['u a0 1'] ={'value':   0.0,'min':-2, 'max': 5, 'fixed':False}
conf['params']['Htildepi']['u a1 1'] ={'value':    0.00000e+00,'min':-2, 'max': 5, 'fixed':True}
conf['params']['Htildepi']['u b0 1'] ={'value':    0.0,'min': 0, 'max':10, 'fixed':False}
...
conf['params']['Htildepi']['d N0 1'] ={'value':   0.0,'min': -10, 'max': 10, 'fixed':False}
conf['params']['Htildepi']['d N1 1'] ={'value':    0.00000e+00,'min': 0, 'max': 1, 'fixed':True}
conf['params']['Htildepi']['d a0 1'] ={'value':    0.0,'min':-2, 'max': 2, 'fixed':False}
conf['params']['Htildepi']['d a1 1'] ={'value':    0.00000e+00,'min':-2, 'max': 2, 'fixed':True}
conf['params']['Htildepi']['d b0 1'] ={'value':    0.0,'min': 0, 'max':10, 'fixed':False}
...
conf['params']['Htildepi']['s N0 1'] ={'value':   0.0,'min': 0, 'max': 1, 'fixed':'d N0 1'}
conf['params']['Htildepi']['s N1 1'] ={'value':    0.00000e+00,'min': 0, 'max': 1, 'fixed':'d N1 1'}
conf['params']['Htildepi']['s a0 1'] ={'value':    0.0,'min':-2, 'max': 2, 'fixed':'d a0 1'}
conf['params']['Htildepi']['s a1 1'] ={'value':    0.00000e+00,'min':-2, 'max': 2, 'fixed':'d a1 1'}
conf['params']['Htildepi']['s b0 1'] ={'value':    0.0,'min': 0, 'max':10, 'fixed':'d b0 1'}
...
conf['params']['Htildepi']['ub N0 1'] ={'value':   0.0,'min': -15, 'max': 2,  'fixed':'d N0 1'}
conf['params']['Htildepi']['ub N1 1'] ={'value':    0.00000e+00,'min': -10, 'max': 10, 'fixed':'d N1 1'}
conf['params']['Htildepi']['ub a0 1'] ={'value':    0.0,'min':-2.5, 'max': 5,  'fixed':'d a0 1'}
conf['params']['Htildepi']['ub a1 1'] ={'value':    0.00000e+00,'min':-2, 'max': 5,    'fixed':'d a1 1'}
conf['params']['Htildepi']['ub b0 1'] ={'value':    0.0,'min': 0, 'max':10,    'fixed':'d b0 1'}
...
conf['params']['Htildepi']['db N0 1'] ={'value':    0.0,'min': -15, 'max': 2,  'fixed':'u N0 1'}
conf['params']['Htildepi']['db N1 1'] ={'value':    0.00000e+00,'min': -10, 'max': 10, 'fixed':'u N1 1'}
conf['params']['Htildepi']['db a0 1'] ={'value':   0.0,'min':-2.5, 'max': 5,  'fixed':'u a0 1'}
conf['params']['Htildepi']['db a1 1'] ={'value':    0.00000e+00,'min':-2, 'max': 5,    'fixed':'u a1 1'}
conf['params']['Htildepi']['db b0 1'] ={'value':    0.0,'min': 0, 'max':10,    'fixed':'u b0 1'}
...
conf['params']['Htildepi']['sb N0 1'] ={'value':   0.0,'min': -15, 'max': 2,  'fixed':'d N0 1'}
conf['params']['Htildepi']['sb N1 1'] ={'value':    0.00000e+00,'min': -10, 'max': 10, 'fixed':'d N1 1'}
conf['params']['Htildepi']['sb a0 1'] ={'value':    0.0,'min':-2.5, 'max': 5,  'fixed':'d a0 1'}
conf['params']['Htildepi']['sb a1 1'] ={'value':    0.00000e+00,'min':-2, 'max': 5,    'fixed':'d a1 1'}
conf['params']['Htildepi']['sb b0 1'] ={'value':    0.0,'min': 0, 'max':10,    'fixed':'d b0 1'}
