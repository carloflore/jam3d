...
conf['params']['pdf']={}
conf['params']['pdf']['uv widths1']  ={'value':    5.72851e-01,'min': 0,'max':1,'fixed':False}
conf['params']['pdf']['uv widths2']  ={'value':    0.00000e+00,'min':-1,'max':1,'fixed':True}
conf['params']['pdf']['dv widths1']  ={'value':    5.72851e-01,'min': 0,'max':1,'fixed':'uv widths1'}
conf['params']['pdf']['dv widths2']  ={'value':    0.00000e+00,'min':-1,'max':1,'fixed':'uv widths2'}
conf['params']['pdf']['sea widths1'] ={'value':    6.03998e-01,'min': 0,'max':1,'fixed':False}
...
conf['params']['ff']['pi+unfav widths1'] ={'value':    1.37349e-01,'min': 0,'max':1,'fixed':False}
...
conf['params']['ff']['k+unfav widths1']  ={'value':    1.86073e-01,'min': 0,'max':1,'fixed':False}
...
conf['datasets']['sidis']['xlsx'][1008]='./simulation.xlsx'  #  proton   | pi+   | FUU  (simulation) 
